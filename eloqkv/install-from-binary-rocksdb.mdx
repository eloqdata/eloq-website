...
EloqKV is compatible with RHEl 7, 8 and 9, Ubuntu 20.04, 22.04 and 24.04. Download
the proper tarball for your operating system from [GitHub Releases](https://github.com/eloqdata/eloqkv/releases).
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-rhel7-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-rhel8-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.18-ubuntu24-amd64.tar.gz
```
