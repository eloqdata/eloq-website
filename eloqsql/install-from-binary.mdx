...
the proper tarball for your operating system from [GitHub Releases](https://github.com/eloqdata/eloqsql/releases).
...
```shell
cd ${HOME}
tar -zxvf eloqsql-0.4.16-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqsql-0.4.16-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqsql-0.4.16-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqsql-0.4.16-ubuntu24-amd64.tar.gz
```
