...
plt.bar([i for i in index], qps_l, bar_width, color=color_l, label='EloqSQL 32c*3')  # Adjust bar positions
...
plt.bar([i  for i in index], lat_l, bar_width, color=color_l, align='center',label='EloqSQL 32c*3')  # Adjust bar positions
