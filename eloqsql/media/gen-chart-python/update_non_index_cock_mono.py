...
plt.bar([i +  bar_width/2 for i in index], qps_l, bar_width, color=color_l, label='EloqSQL 16*3')  # Adjust bar positions
plt.bar([i + 3*bar_width/2 for i in index], qps_x, bar_width, color=color_x, label='EloqSQL 32*3')  # Adjust bar positions
