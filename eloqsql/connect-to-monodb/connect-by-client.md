...
1. [Navicat](https://navicat.com/en/products)
   ...
   ![](../media/connect-to-eloqdb/client/navicat-for-mysql-download.png)
   Open the Navicat client and create a MariaDB connection
   ![](../media/connect-to-eloqdb/client/navicat-new-sql-connection.jpg)
   Enter the IP of the server (Host) where the database is located, the port (Port) number (3300 by default), the database user name (User Name) is `eloq` and the user password set when creating the user to complete the connection settings .
   ![](../media/connect-to-eloqdb/client/navicat-connection-setting.jpg)
   After the test connection is successful, save the connection and create a new query
   ![](../media/connect-to-eloqdb/client/navicat-connection-new-query.jpg)
   Write the SQL statement and click Run, it runs successfully.
   ![](../media/connect-to-eloqdb/client/navicat-sql-execution.jpg)
...
2. [Oracle MySQL Workbench](https://dev.mysql.com/downloads/file/?id=517975)
   ...
   ![](../media/connect-to-eloqdb/client/workbench-new-sql-connection.jpg)
   Enter the IP of the server (Host) where the database is located, the port (Port) number (3300 by default), the database user name (User Name) is `eloq` and the user password set when creating the user to complete the connection settings .
   ![](../media/connect-to-eloqdb/client/workbench-connection-setting.jpg)
   connection succeeded
   ![](../media/connect-to-eloqdb/client/workbench-connection-success.jpg)
   Create a new query, write a SQL statement and click Run.
   ![](../media/connect-to-eloqdb/client/workbench-sql-execution.jpg)
...
![](../media/connect-to-eloqdb/client/SQLyog-new-sql-connection.jpg)
Enter the IP of the server (Host) where the database is located, the port (Port) number (3300 by default), the database user name (User Name) is `eloq` and the user password set when creating the user to complete the connection settings .
![](../media/connect-to-eloqdb/client/SQLyog-connection-setting.jpg)
connection succeeded
![](../media/connect-to-eloqdb/client/SQLyog-connection-success.jpg)
Create a new query, write a SQL statement and click Run.
![](../media/connect-to-eloqdb/client/SQLyog-sql-execution.jpg)
