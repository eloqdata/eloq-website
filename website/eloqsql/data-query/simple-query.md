---
title: Simple Query
summary: Introduce the basic query functions in EloqSQL
sidebar_position: 1
---
...
1. Build a EloqSQL cluster (you can use [single machine build](../quick-start.md) or [multiple machine build](../cluster-deployment.md))
