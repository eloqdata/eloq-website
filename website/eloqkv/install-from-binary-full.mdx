...
EloqKV is compatible with RHEl 7, RHEL 8, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04 and Ubuntu 24.04.
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-rhel8-amd64.tar.gz
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-rhel9-amd64.tar.gz
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-ubuntu18-amd64.tar.gz
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-ubuntu20-amd64.tar.gz
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-ubuntu22-amd64.tar.gz
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocksdb/eloqkv-0.6.3-ubuntu24-amd64.tar.gz
