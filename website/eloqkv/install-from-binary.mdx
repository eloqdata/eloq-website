...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/centos7/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/centos8/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/rocky9/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/ubuntu1804/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/ubuntu2004/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/ubuntu2204/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://download.eloqdata.com/eloqkv/ubuntu2404/rocksdb/eloqkv-0.6.0-amd64.tar.gz
tar -zxvf eloqkv-0.6.0-amd64.tar.gz
```
