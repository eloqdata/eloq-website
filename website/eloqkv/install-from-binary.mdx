...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-rhel7-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-rhel8-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.6-ubuntu24-amd64.tar.gz
```
