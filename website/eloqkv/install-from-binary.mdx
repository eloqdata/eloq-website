...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-rhel7-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-rhel8-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.20-ubuntu24-amd64.tar.gz
```
