...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/centos7/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/centos8/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/ubuntu1804/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/ubuntu2004/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/ubuntu2204/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
...
```shell
cd ${HOME}
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/ubuntu2404/rocksdb/eloqkv-1.0.13-amd64.tar.gz
tar -zxvf eloqkv-1.0.13-amd64.tar.gz
```
