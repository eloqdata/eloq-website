...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.7.2-rhel8-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.7.2-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.7.2-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.7.2-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.7.2-ubuntu24-amd64.tar.gz
```
