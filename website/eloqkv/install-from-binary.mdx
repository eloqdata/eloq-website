...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-rhel7-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-rhel8-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-rhel9-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-ubuntu20-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-ubuntu22-amd64.tar.gz
```
...
```shell
cd ${HOME}
tar -zxvf eloqkv-0.8.19-ubuntu24-amd64.tar.gz
```
