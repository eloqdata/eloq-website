---
title: Deploy EloqKV With Tarball
---
...
```shell
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/centos8/rocksdb/eloqkv-latest-amd64.tar.gz
mkdir /home/centos/eloqkv
tar -zxvf eloqkv-latest-amd64.tar.gz -C /home/centos/eloqkv
```
...
```shell
wget https://d143xau9fe26d8.cloudfront.net/eloqkv/ubuntu2004/rocksdb/eloqkv-latest-amd64.tar.gz
mkdir /home/centos/eloqkv
tar -zxvf eloqkv-latest-amd64.tar.gz -C /home/centos/eloqkv
```
