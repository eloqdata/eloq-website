...
summary: This article makes a detailed comparison between MonographDB and MySQL in terms of syntax and functional characteristics.
---

#Comparison with MySQL compatibility

MonographDB is highly compatible with the MySQL 8.0 protocol, common functions and syntax. The system tools in the MySQL 8.0 ecosystem and the clients(PHPMyAdmin, Navicat, MySQL Workbench, mysqldump, Mydumper/Myloader, etc), which are all applicable to MonographDB.

But MonographDB does not yet support some MySQL features, the possible reasons are as follows:
