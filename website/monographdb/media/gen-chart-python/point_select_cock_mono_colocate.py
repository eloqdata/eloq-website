...
qps_x=[306670.95,517454.86,739429.56,811595.01,770954.76]
lat_x=[0.33,0.39,0.68,1.23,2.59]
lat95_x=[0.46,0.56,1.04,2.11,3.96]
...
plt.bar([i - bar_width/2 for i in index], lat_m, bar_width, color=color_m, align='center',label='NewSQL 32*3')
plt.bar([i +  bar_width/2 for i in index], lat_l, bar_width, color=color_l, align='center',label='MonographDB 16*3')  # Adjust bar positions
plt.bar([i + 3*bar_width/2 for i in index], lat_x, bar_width, color=color_x, align='center',label='MonographDB 32*3')  # Adjust bar positions
