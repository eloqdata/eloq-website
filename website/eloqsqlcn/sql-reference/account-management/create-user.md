...
- `authentication_option`：指定账户的身份验证方式，在 EloqSQL 中支持如下的三种方式
...
- `lock_option`:EloqSQL 支持帐户锁定，允许特权管理员锁定/解锁用户帐户
...
> **注意**
> 使用`ed25519`插件的前提是相应的 EloqSQL 已经加载，如果没有加载需要执行下述的 SQL 语句进行安装。
>
> ```sql
