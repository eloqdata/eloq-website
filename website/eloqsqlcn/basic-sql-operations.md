---
title: SQL 基本操作
summary: 利用EloqSQL进行基本的SQL操作
---

# SQL 基本操作

成功部署 EloqSQL 集群之后，便可以连接数据库执行相应的 SQL 语句。由于 EloqSQL 兼容 MySQL，用户可以使用 MySQL 客户端连接 MonograhDB，并且可以直接执行相应的 SQL 语句（**注意**：部分 Mysql 语句不支持，具体可见[与 Mysql 兼容性对比](./mysql-compatibility.md)
