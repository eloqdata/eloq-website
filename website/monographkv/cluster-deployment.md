---
title: The guide for deploy a MonographKV Cluster
summary: Learn how to deploy and use the MonographKV cluster
---

# The guide for deploy a MonographKV Cluster

This document describes how to quickly deploy a MonographKV cluster on multiple Linux servers.
...
- The Linux systems need to have access to the Internet, which is required to download MonographKV and its related dependencies.

For the MonographKV cluster topology, you can configure the required number of clusters on demand by changing the YAML file. In this deployment, the cluster topology is shown in the following table.
...
- Create and start the cluster
  ...
  - `install_image`: Can be set to the downloaded Monograph installation package locally or the download address of the remote MonographKV
  ...
  - `monitor`: Configure the remote download URL, installation location and installation port of MonographKV’s related monitoring software (prometheus, grafana).
