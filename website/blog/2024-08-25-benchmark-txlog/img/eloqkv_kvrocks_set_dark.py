...
ax2 = ax1.twinx()
line1_read = ax2.plot(index_read, kvrocks_ebs_lat, 'b--', marker='o', color='#008080', label='EloqKV 32C 1D Latency', linewidth=2)
line2_read = ax2.plot(index_read, kvrocks_ssd_lat, 'g--', marker='o', color='#6A5ACD', label='EloqKV 32C 2D Latency', linewidth=2)
line3_read = ax2.plot(index_read, eloqkv_ebs_lat, 'r--', marker='o', color='#FFA500', label='EloqKV 32C 4D Latency', linewidth=2)
line3_read = ax2.plot(index_read, eloqkv_ssd_lat, 'r--', marker='o', color='#FF4500', label='EloqKV 32C 6D Latency', linewidth=2)
