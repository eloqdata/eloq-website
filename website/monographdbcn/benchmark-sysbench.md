---
title: MonographDB Sysbench 性能测试报告
---
...
本测试旨在评估 MonographDB 在不同集群规模下的可伸缩性和性能，集群规模分别为：
...
从 T-Shirt S 到 T-Shirt M 验证 MonogrpahDB 的 scale up 能力，从 T-Shirt M 到 T-Shirt L 验证 MonogrpahDB 的 scale out 能力。传统 DB 在 scale up 的时候无法提升写入能力，因为磁盘往往成为系统瓶颈，但是 MonographDB 支持水平扩展 logservice，并发写入多块磁盘，因此具有优秀的写入负载 scale up 的能力。
