...
5. Create the database basic schema like database, table object etc.. Note that MonoSQL has its schema best practice and you may need to using AWS DMS [transformation rule](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TableMapping.SelectionTransformation.Transformations.html) to convert the schema for MonoSQL. Follow [MonoSQL schema best practice](http://monographdata.com/docs/monosql-data-migration-overview) for details.
6. Create **secret** in [Secret Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html)
...
![](media/show_master_status.png)

2. If you encounter errors like the following:
