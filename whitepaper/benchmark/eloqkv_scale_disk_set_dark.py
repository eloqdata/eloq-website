...
bar1_read = ax1.bar(index_read - 2*bar_width, eloqkv_d1, bar_width, alpha=0.8, color='#1f77b4', label='EloqKV Core32 Disk1')
bar2_read = ax1.bar(index_read - 1*bar_width, eloqkv_d2, bar_width, alpha=0.8, color='#ff7f0e', label='EloqKV Core32 Disk2')
bar3_read = ax1.bar(index_read, eloqkv_d4, bar_width, alpha=0.8, color='#2ca02c', label='EloqKV Core32 Disk4')
bar4_read = ax1.bar(index_read+ bar_width, eloqkv_d6, bar_width, alpha=0.8, color='#d62728', label='EloqKV Core32 Disk6')
bar5_read = ax1.bar(index_read + 2*bar_width, eloqkv_d8, bar_width, alpha=0.8, color='#9467bd', label='EloqKV Core32 Disk8')

ax1.set_xlabel('Concurrency Levels', color='white')
ax1.set_ylabel('Throughput (K)', color='white')
ax1.set_title('Scale Disk Write Workload Comparison', color='white')
