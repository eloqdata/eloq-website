...
bar1_read = ax1.bar(index_read - 1.5*bar_width, eloqkv_d8, bar_width, alpha=0.8, color='#1f77b4', label='EloqKV Core32 Disk8')
bar2_read = ax1.bar(index_read - 0.5*bar_width, eloqkv_d10, bar_width, alpha=0.8, color='#ff7f0e', label='EloqKV Core32 Disk10')
bar3_read = ax1.bar(index_read + 0.5*bar_width, eloqkv_d8_48, bar_width, alpha=0.8, color='#2ca02c', label='EloqKV Core48 Disk8')
bar4_read = ax1.bar(index_read+ 1.5*bar_width, eloqkv_d10_48, bar_width, alpha=0.8, color='#d62728', label='EloqKV Core48 Disk10')
