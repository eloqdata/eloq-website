...
redis_read_throughput = [241.946, 231.713, 223.036]  # converted to K
dragonfly_read_throughput = [672.755, 1161.309, 1750.044]  # converted to K
eloqkv_read_throughput = [1012.709, 1464.525, 1738.958]  # converted to K

redis_read_latency = [0.836,1.508, 5.087]
dragonfly_read_latency = [0.295, 0.391, 1.113]
eloqkv_read_latency = [0.31, 0.57, 1.85]
...
ax1.set_title('Read Only Workload Comparison', color='white')
