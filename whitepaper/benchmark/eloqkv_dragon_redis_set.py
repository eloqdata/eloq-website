...
bar2_read = ax1.bar(index_read, dragonfly_read_throughput, bar_width, alpha=0.8, color='#ef5675', label='Dragonfly Throughput')
...
ax1.set_title('Set Workload Comparison')
...
ax2 = ax1.twinx()
line1_read = ax2.plot(index_read, redis_read_latency_ms, 'b--', marker='o', color='#7a5195', label='Redis P999 Latency')
line2_read = ax2.plot(index_read, dragonfly_read_latency_ms, 'g--', marker='o', color='#ef5675', label='Dragonfly P999 Latency')
line3_read = ax2.plot(index_read, eloqkv_read_latency_ms, 'r--', marker='o', color='#ffa600', label='EloqKV P999 Latency')

ax2.set_ylabel('P999 Latency (ms)')
